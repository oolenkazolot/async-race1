...
class Garage {
  ...
  private createNameAuto(name: string): HTMLElement {
    const nameAuto: HTMLElement = document.createElement("span");
    nameAuto.classList.add("garage__name-auto");
    nameAuto.textContent = name;
    return nameAuto;
  }
